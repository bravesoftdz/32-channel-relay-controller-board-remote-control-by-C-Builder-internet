...
__published:	// IDE-managed Components
	...
	void __fastcall Style11Click(TObject *Sender);
	void __fastcall Style21Click(TObject *Sender);
	void __fastcall FormCreate(TObject *Sender);
	void __fastcall Style31Click(TObject *Sender);
	void __fastcall Style41Click(TObject *Sender);
